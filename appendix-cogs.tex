...
\begin{claim}\label{claim:!-free-decomposition}
    If $v \in \Ker_\EE \cal O$ is free from conflicts, then it can be written as a linear combination of $\cal O$-cogs:
    \[
...
\begin{claim}\label{claim:?-free-decomposition}
     If $v \in \Ker_\EE \cal O$ has no equational conflicts, then it can be written as a linear combination of $\cal O$-cogs:
    \[
        v = \sum_{a^\pm \in A^\pm} \lambda_{a^\pm} \cdot a^+ \between a^-
    \]

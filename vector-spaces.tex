...
\begin{definition}
    ...
    of $\Lin_\field X$.%
    \footnote{The supremum of the chain lengths is called the \emph{length} of $\Lin_\FF X$, which is a standard notion in algebra. We will use standard properties about lengths in the sections that follow. See Section~\ref{sec:appendix-modules} in the appendix for a refresher and for a proof of Theorem~\ref{thm:ACP}.}
\end{definition}

...
\textcolor{red}{Also, we don't know how to test for isomorphism --- oops!}
...
In light of Theorem~\ref{thm:ACP} \textcolor{red}{how exactly?}, we could have used $\A^d$ instead of $X$ in the above definition.

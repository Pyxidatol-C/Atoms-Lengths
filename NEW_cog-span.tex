...
\begin{center}
\begin{tikzpicture}[font=\sffamily, line cap=round, line join=round, >={Latex[length=3.6mm,width=2.4mm]}, scale=0.8]
...
$\pi(a_i) \not\in X$, 
$\pi(a_i) > a_i$, 
$\pi(a_i) \forkindep a_i$. % This 'stationary independence relation' symbol means: 

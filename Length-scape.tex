...
(This restriction is necessary for tackling forbidden substructures, but we believe the proofs can be adapted to handle the Fraïssé limit of ordered $k$-uniform hypergraphs.
\textcolor{red}{With more effort, it also seems possible to recover Evans's result \cite[Proposition~3.10]{Evans_pm1} that $\Lin \A^2$ has finite length without this arity assumption; 
it is worth pondering to what extend the Ramsey property \cite[Theorem~1.2]{EvansHubickaNesetril_2021} used there could simplify our proof.}) 

...
\lipicsEnd\end{example}
 ...
 For this reason, we need a more general notion of a vector space, in a style that emphasises the group action as in Definition~\ref{def:orbit-finite-set-alternative}.

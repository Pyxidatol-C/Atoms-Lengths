...
\lipicsEnd\end{example}
 ...
 In particular, these spaces are not closed~---~even up to equivariant linear bijections~---~under taking equivariant subspaces, or quotients under such spaces. 
...
Like mentioned in the introduction, the finite length property can be \textcolor{magenta}{strictly stronger} than the ascending chain property, as witnessed by the vector atoms from Example~\ref{ex:vector-space-atoms}. 

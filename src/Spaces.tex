...
\lipicsEnd\end{example}
 ...
 The problem with subspaces is apparent already in Example~\ref{ex:length-one-dim-one}, since the unique non-trivial subspace of $\Lin_\field \A$ does not have any equivariant basis, regardless of the underlying field~\cite[Ex.~6.1]{BFKM24}; 

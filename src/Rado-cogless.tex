...
\end{figure}
   ...
   %     where the supremum ranges over finite sets of atoms.
    ...
    This will let us leverage an elementary result from representation theory called Maschke's Theorem (see e.g.~\cite[Thm.~6.3]{RepTheoryTextbook}).
    Recall that $\oplus$ stands for the direct sum of vector spaces, i.e.~$V \oplus W$ is the set of pairs $(v,w)$ with $v \in V$ and $w \in W$, where the operations are defined coordinate-wise.

...
\begin{proof}[Proof of Theorem~\ref{thm:have-oligomorphic-approximation}]
    ...
    \begin{romanenumerate}
        \item 
        For the equality atoms, we can simply choose $\Bclass$ to be all finite sets. 
        These are all homogeneous: we can extend a bijection between subsets to a permutation.

        \item 
        For the vector atoms, we can also choose $\Bclass$ independently of $d$ to be the family of all vector spaces of finite dimension. 
...
\end{figure}
   ...
   %     where the supremum ranges over finite sets of atoms.
    ...
    \begin{proof}
        ...
        \begin{align*}
        V_0 \subset V_1 \subset \dots \subset V_n = \Lin \A^d,
        \end{align*}

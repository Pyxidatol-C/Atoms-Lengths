...
e.g.~Frankael and Mostowski showed that the axiom of choice can fail, working over the atoms from the first two rows, some twenty years before Cohen's independence proof in the setting without atoms \cite[Ch.~4]{Jech}.)

...
here it's easier to specify the age (\textcolor{magenta}{define!}) rather than the concrete structure.
...
\begin{claim}\label{claim:reduction-to-one-orbit}
    \color{magenta}
    The following are equivalent for every finite $S \subset \A$ (where $\A$ is oligomorphic):

...
\begin{example}[Equality atoms] \label{ex:equality-atoms} 
    ...
    For instance, if two tuples $(a_1, a_2)$ and $(b_1, b_2)$ both have non-repeating entries, then the mapping $a_1 \mapsto b_1, a_2 \mapsto b_2$ can be extended to a permutation of the whole structure.
...
\begin{example}[Ordered atoms] \label{ex:order-atoms} 
    ...
    For instance, for two tuples $(a_1, a_2)$ and $(b_1, b_2)$ such that $a_1<a_2$ and $b_1<b_2$, mapping $a_1 \mapsto b_1, a_2 \mapsto b_2$ can be extended to an automorphism.

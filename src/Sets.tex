...
in the sense that they describe the same sets, up to equivariant bijections: see~\cite[Thm.~5.12]{bojanczyk_slightly} and~\cite[Prop.~2.19]{BodirskyBodorMarimon_25}. 

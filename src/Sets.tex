...
On the other hand, some constructions (e.g.~disjoint unions, Cartesian products) are more naturally presented using the more abstract Definition~\ref{def:orbit-finite-set-alternative}. 

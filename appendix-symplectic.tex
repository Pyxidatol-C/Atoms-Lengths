...
As symplectic vector spaces are an important and interesting structure to understand, we reproduce a self-contained exposition here, taking a straight-line path to oligomorphic approximation.
...
\begin{proof}[Proof (without graph-theoretic jargon)]
    ...
    Then we have $\omega(f'(x), f'(s)) = \llbracket E(x, s) \rrbracket$ 
    and $\omega(f'(x), f'(t)) = \llbracket E(x, t) \rrbracket$ as desired, on one hand.
    On the other,
    \begin{align*}
        \omega( f'(x_1), f'(x_2) ) 

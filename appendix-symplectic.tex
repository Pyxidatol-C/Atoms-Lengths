...
\section{Proof of Theorem~\ref{thm:have-oligomorphic-approximation}(3)}\label{sec:appendix-symplectic}
\textcolor{red}{Explain why I produced a self-contained exposition while this subject is known to mathematicians.}
...
\begin{proposition}[Witt Extension] \label{prop:symplectic-witt-extension}
    ...
    can be extended to an isometric linear bijection of $\W_n$ to itself,
...
\begin{proof}
    ...
    and that it may be extended to an \textcolor{red}{automorphism} $\pi$ of $\W_\infty$ by Propsoition~\ref{prop:symplectic-witt-extension}.

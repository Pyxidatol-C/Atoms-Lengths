...
\section{A tutorial on symplectic spaces and graphs}\label{sec:appendix-symplectic}
...
As symplectic vector spaces are an important and interesting structure to understand, we provide a self-contained exposition here, taking a tourist path to the oligomorphic approximation of the Rado graph in Theorem~\ref{thm:appendix-rado-oligo-approx}.

...
Described as a classical geometry, it can indeed be found in classical textbooks such as \cite[pp.~114--121]{Artin_symplectic} and \cite[pp.~75--83]{Aschbacher_symplectic},
...
\begin{proposition}[Witt Extension] \label{prop:symplectic-witt-extension}
    ...
    can be extended to an isometric linear bijection of $\W_n$ to itself (i.e.~automorphism),
...
by Theorem~\ref{thm:weak-smooth-approximation-finite-length} we establish the finite length property for yet another class of structures:
\begin{corollary}
...
\end{proposition}
\begin{proof}
    Clearly any isometric linear bijection of $\W_n$ is a graph automorphism of $\widetilde \W_n$.

...
\end{itemize}
In particular, a special case of either of these techniques is the Rado atoms (row~3 in Figure~\ref{fig:fraisse-limits}), where even the weaker ascending property was not known before.

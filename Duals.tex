...
\end{description}
The answer to the above question  is  ``yes'' for the equality and order atoms, which was shown in~\cite[Corollary 6.8]{BFKM24} for a special case of function spaces, namely duals, with the  general case of function spaces being treated in~\cite[Section 8.3]{bojanczyk_slightly}. 

...
On the other hand, the Rado atoms fails this property, as explained in the following example. (In particular, the finite length property does not imply the function space property.)

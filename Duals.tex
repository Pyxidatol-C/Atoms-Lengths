...
\begin{myexample}\label{ex:no-function-spaces}
    ...
    to be the functions $f_S$, where $S$ ranges over finite sets of atoms.\footnote{The example would also work for the Hensen graphs that will be defined later, but for that $S$ will only range over anti-cliques.} 

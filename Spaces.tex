...
\begin{definition}[Orbit-finite-dimensional vector spaces]\label{def:orbit-finite-basis}
...
In light of Theorem~\ref{thm:ACP} and the proof of (3) $\Rightarrow$ (2) in Appendix~\ref{sec:appendix-modules}, we could have used $\A^d$ instead of $X$ in the above definition.

...
\begin{myexample}\label{ex:geneircally-ordered-equality}
...
\begin{myexample}\label{ex:geneircally-ordered-graphs}
...
However, once that is done, we can naturally view $\Lin_\EE \cal O$, $\Ker_\EE \cal O$, and $\Cog_\EE \cal O$ as vector spaces over $\FF$.
\end{remark}
...
\begin{myexample}
    When $\A$ is the ordered atoms and $d = 1$,
    the maps are
    \begin{align*}

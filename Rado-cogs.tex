...
\begin{corollary}\label{cor:lachlan-woodrow}
    ...
    \color{magenta}
    \begin{enumerate}
        \item the ordered atoms, the equality atoms;
        \item every countable homogeneous graph;
        \item the universal homogeneous tournament;
        \item dense linear order with a dense co-dense unary predicate;
        \item all homogeneous tournaments, thanks to Lachlan again!
    \end{enumerate}

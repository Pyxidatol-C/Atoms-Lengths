...
\end{corollary}
\begin{proof}
    A chain of $\Aut(\A_0)$-equivariant subspaces in $\Lin_\FF \A_0^d = \Lin_\FF \A^d$ is also a chain of $\Aut(\A)$-equivariant subspaces,
...
We will proceed in several steps, with the general idea similar to \cite[\S4.1]{BFKM24}, but with significant new complications arising from the presence of nontrivial relations in $\A_0$.

...
Otherwise \[
    v = v^{d:a} + v^{d:b} + v'
\]
for some $a\neq b\in \A$. By Lemma~\ref{lem:balanced-projected-subvector}, $v^{d:a}|^{-d}$ is balanced, and it is obviously conflict-free, as it is a subvector of $v$.
...
so one last application of Lemma~\ref{lem:!} allows us to assume that
\[

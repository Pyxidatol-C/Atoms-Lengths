...
\begin{myexample}\label{ex:free-amalg-graphs}
    ...
    \end{align*}    
    are all free amalgamation classes.
\end{myexample}
...
By Theorem~\ref{thm:coeff-approximation}, it suffices to check whether $\mathbf{b} {\restriction_i} (\cal O_i) \subseteq \mathbf{A}_{-, j_1} {\restriction_i} (\cal O_i) + \cdots + \mathbf{A}_{-, j_r} {\restriction_i} (\cal O_i)$, in the finite dimensional space $\FF^{n_i}$, having chosen orbit representatives $j_1, \dots, j_r \in \A^d$.

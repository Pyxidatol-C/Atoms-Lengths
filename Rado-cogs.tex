...
\begin{myexample}\label{ex:generically-ordered-graphs}
    ...
    The ordered Rado graph was studied in \cite{BPP15}. The triangle-free  Henson graph will be studied in an extended example in Section~\ref{ex:extended-example}.
\end{myexample}

Using a classification result of Lachlan and Woodrow~\cite{LachlanWoodrow_80}, we can get the following general result.

\begin{theorem}\label{thm:lachlan-woodrow}
...
(This is not the case if $\A$ is the ordered atoms: see the proof of \cite[Cl.~4.7]{BFKM24}.)
...
this latter is more traditionally viewed as $\Lin_\FF \cal O \oplus \Lin_\FF \cal O$.)
...
see in \cite[Cor.~3.17]{Gray97}, \cite[Thm.~15]{HofmanLerouxTotzke_17}, \cite[Thm.~3.4]{HofmanRozycki_2022}, and \cite[Thm.~19]{Arka_notes}, \cite[Sec.~6]{GhoshHofmanLasota_22}.

\section{Proofs of Theorem~\ref{thm:coeff-approximation} and Corollary~\ref{cor:2d-length}}\label{sec:appendix-eqsubsp}
...
Now let $\cal O \subseteq \A^d$ be an ordered orbit.
...
\end{proposition}
\begin{proof}
    We obtain $t$ chains \textcolor{red}{These $t$ come from previously:}
    \begin{align*}

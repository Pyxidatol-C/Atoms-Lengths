\section{Proofs missing in Section~\ref{sec:equivariant-subspaces}}
...
To complement the upper bound from Prop.~\ref{prop:length-upper-bound}, we now exhibit a chain of $\Aut(\A/S)$-equivariant subspaces whose length is precisely $\sum_{i=1}^t |\Jclass_i|$, generalising \cite[Corollary~4.12]{BFKM24}.

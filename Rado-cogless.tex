...
The above definition is a relaxation of a stronger notion from model theory that is called \emph{smooth approximation}. In the stronger notion, the family $\Bclass$ is independent of $d$, \textcolor{red}{and there are other requirements as well}~\cite[p.~440]{KLM89}. 

...
Consider the rational numbers with the usual order. The finite substructures in this case are finite total orders, and already for dimension $d=1$, a finite total order of size $n$ will have $n$ orbits. 
...
\begin{proof}[Proof of Theorem~\ref{thm:have-oligomorphic-approximation}]
    ...
    \begin{enumerate}
        ...
        will be a family of \emph{symplectic graphs}: see~\cite[Sec.~8.11]{GR01}.%
...
\begin{corollary}\label{cor:weak-finite-length}
    Over any field of characteristic $0$, the following structures have  the finite length property: (1) the equality atoms; (2) the vector atoms; and (3) the Rado atoms.
\end{corollary}

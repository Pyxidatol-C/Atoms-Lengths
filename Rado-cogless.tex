...
\begin{proof}
    ...
    but this is impossible as we assumed linear independence.
    So $e_{n+i+1}$ does not belong to
    \begin{align*}
        &\langle e_1, \ldots, e_{n+i}, e_{n+i+2}, \dots, e_{n+k}, f_1, \ldots, f_{n+i} \rangle \\
        ={} &\langle e_1, \ldots, e_{n+i}, e_{n+i+2}, \dots, e_{n+k}, f_1, \ldots, f_{n+i} \rangle^{\perp \perp};
    \end{align*}
    put in other words, we must be able to find some vector $f_{n+i+1}$ that satisfies $\omega(e_{n+i+1}, f_{n+i+1}) = 1$ 
    as desired from $\langle e_1, \ldots, e_{n+i}, e_{n+i+2}, \dots, e_{n+k}, f_1, \ldots, f_{n+i} \rangle^\perp$.
\end{proof}

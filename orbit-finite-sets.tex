...
Let us justify the name ``orbit-finite'' in the above definition. 
...
Let us now explain how the above definition coincides with first-order interpretations. We can think of an orbit-finite set as a relational structure, by equipping it with some relations that are equivariant with respect to the action of the automorphism group of $\A$. 

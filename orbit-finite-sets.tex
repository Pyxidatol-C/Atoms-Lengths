...
We start with an infinite structure $\A$, as described in Section~\ref{sec:structures}, whose elements we call \emph{atoms}. These can be used to construct sets that are finite up to the symmetries of $\A$, such as
\begin{align*}

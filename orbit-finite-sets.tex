...
We start with a countable oligomorphic structure $\A$, as described in Section~\ref{sec:structures}, whose elements we call \emph{atoms}. 
...
in the sense that they describe the same sets, up to equivariant bijections --- see~\cite[Thm.~5.13]{bojanczyk_slightly}. 
